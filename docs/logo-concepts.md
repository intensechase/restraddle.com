...
- **Core base = single flat ink color**, not yet tied to site palette —
  ...
  - (if you meant something different by "colored shirts" for the black
    version than the white one, flag it — I'm assuming the standard
    light/dark split above)
...
> Flat vector logo wordmark, all solid white, "reS" lowercase/uppercase
...
> weight, no serifs. Single flat white color throughout, transparent
...
**White ink (for dark/black garments):**
> Flat vector logo wordmark, all solid white, "reSTR" uppercase, then a
...
> sans-serif, heavy weight, no serifs. Single flat white color throughout,
...
**White ink (for dark/black garments):**
> Flat vector combo logo, all solid white, the text "re" lowercase directly
...
> both sides. Single flat white color throughout, transparent background.
...
**White ink (for dark/black garments):**
> Flat vector icon logo, all solid white, a single bold letter "R"
...
> shape with a thin outline border. Single flat white color throughout,
