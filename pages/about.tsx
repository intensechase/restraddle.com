    ...
    <div className="min-h-screen">
      ...
      <div className="mx-auto max-w-2xl px-7 py-16">
        ...
        <div className="space-y-6 text-[15.5px] leading-relaxed text-ink">
          <p>
            A restraddle isn&apos;t exotic. Most players who&apos;ve sat in a real cash game have seen one&hellip;
            someone posts a straddle from a seat that isn&apos;t UTG, and the table either knows exactly what that
            means or spends thirty seconds arguing about it. The Idaho Straddle specifically&hellip; restraddle from
            anywhere, whoever posts last gets ultimate last action, but only preflop&hellip; is one version of that
            argument, played out enough times in enough home games to earn its own name. That&apos;s where this
            site&apos;s name comes from. Not a metaphor, just the actual rule.
          </p>

          <p>
            This isn&apos;t a beginner site, and it&apos;s not trying to be. If you need &ldquo;what beats
            what&rdquo; explained, there are a hundred places for that. This one assumes you already play&hellip;
            that you&apos;ve got a regular game, you know your outs, and what you actually want is the stuff nobody
